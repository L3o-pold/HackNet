...
.controller('terminalController', ['$scope', 'terminalConfiguration', 'promptCreator', '$rootScope', function ($scope, terminalConfiguration, promptCreator, $rootScope) {
    ...
    $scope.init = function (configName) {
        ...
        config.promptConfiguration.user = $rootScope.user.current.first_name;
